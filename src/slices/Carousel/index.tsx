...
const FLAVORS: {
  ...
  { flavor: "fanta", color: "#FF4500", name: "Fanta" },
  { flavor: "pepsi", color: "#1E90FF", name: "Pepsi" },
  { flavor: "sprite", color: "#00FF7F", name: "Sprite" },
  { flavor: "coca", color: "#000000", name: "Coca Cola" },
  { flavor: "fizz", color: "red", name: "Appy Fizz" },
];
/**
 * Props for `Carousel`.
 */
